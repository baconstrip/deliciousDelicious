...
class LinuxServer(Display):
    ...
    def __init__(self,name, data):
        ...
        self.addElement(Label("Label2", 3, stdoutData2.decode("UTF-8")))
    ...
    def update(self, delta):
        ...
        self.updateLayout("Label1",  "Memory Used:")
        self.updateLayout("Label2",  stdoutData1)
        self.updateLayout("Label3",  "Maximum Mememory:")
        self.updateLayout("Label4",  stdoutData2)

        self.updateLayout("Label5",  "CPU Usage:")
        self.updateLayout("Label6",  stdoutData3)
